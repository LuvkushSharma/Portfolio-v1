...
export function NavigationBar() {
    ...
    return (
        <>
            <NavigationMenu className="hidden sm:flex sm:sticky sm:top-0 min-w-full bg-black bg-opacity-20 backdrop-blur-lg container py-4 justify-between border-b border-border/40 z-50">
                <Avatar className="cursor-pointer" onClick={() => scrolltoHash("hero")}>
                    <AvatarImage src="https://avatars.githubusercontent.com/u/121566305?v=4&size=64" alt="@Luvkush" />
                ...
                <NavigationMenuList className="w-full justify-end">
                    ...
                    <NavigationMenuItem className="cursor-pointer">
                        <NavigationMenuLink className={navigationMenuTriggerStyle()} onClick={() => scrolltoHash("education")}>
                            Education
                        </NavigationMenuLink>
                    </NavigationMenuItem>
                    <NavigationMenuItem className="cursor-pointer">
