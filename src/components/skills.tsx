...
export default function Skills() {
                ...
                >
                    <div className="flex flex-col items-center justify-center gap-2">
                        ...
                        <div className="flex flex-row flex-wrap justify-center gap-4">
                            ...
                            {/* MongoDB */}
                            <div className="flex flex-col items-center justify-center">
    <img src="https://www.vectorlogo.zone/logos/mongodb/mongodb-icon.svg" alt="MongoDB Icon" className="w-24 h-24 hover:animate-spin" />
    <p className="text-sm text-muted-foreground">MongoDB</p>
                            ...
                            {/* Microsoft Azure */}
                            <div className="flex flex-col items-center justify-center">
    <img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/Microsoft_Azure.svg" alt="MongoDB Icon" className="w-24 h-24 hover:animate-spin" />
